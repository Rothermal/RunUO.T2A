	...
	public class Kirin : BaseMount
	{
		...
		public override bool DoMountAbility( int damage, Mobile attacker )
		{
			...
			if( (Rider.Hits - damage) < 30 && Rider.Map == attacker.Map && Rider.InRange( attacker, 18 ) )	//Range and map checked here instead of other base fuction because of abiliites that don't need to check this
			{
                ...
                this.Damage( Utility.RandomMinMax( 35, 100 ), attacker, false );	//Don't inform mount about this damage, Still unsure wether or not it's flagged as the mount doing damage or the player.  If changed to player, without the extra bool it'd be an infinite loop
